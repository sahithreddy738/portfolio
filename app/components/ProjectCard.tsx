...
const ProjectCard = (props: ProjectCardProps) => {
  return (
    <Link href={props.toLink}>
      ...
      <Image src={props.projectImage} alt="project-img" className="aspect-auto rounded-lg" width={250} height={250} ></Image>
      ...
      <div className="flex flex-wrap gap-2">
        {props.projectTech.map((skill,index) => (
          <div
            className="w-auto px-4 text-center py-1 h-8 border-black bg-zinc-100 rounded-full"
            key={index}
          >
